...
def probe_job(output_dir: Path) -> dict[str, Any]:
    ...
    if not asset.exists():
        ...
        image.save(asset)
    return {
        "document": {"width": 360, "height": 220, "resolution": 72, "depth": 8, "name": "codex-v3.6.2-probe"},
        "output": {
        ...
        "layers": [
            ...
            {
                "id": "probe_root", "name": "Bg_ProbeRoot", "kind": "shape", "shape": "rounded-rectangle",
                "z": 5, "bounds": [8, 8, 28, 28], "radius": 4, "fill": "#DB2777",
            },
            ...
            },
            {
                ...
                "bounds": [74, 88, 250, 126], "baseline_y": 124, "text": "Codex v3.6.2", "font": "Arial-BoldMT",
