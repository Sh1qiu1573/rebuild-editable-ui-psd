...
Human review is blocking in v3.6.2. Record both review rounds in `human-review.json`. Do not infer approval from silence, a previous task, or an AI assessment.
...
- Wrong text transcription or text-unit grouping, and decorative headline lettering incorrectly classified as editable text instead of raster artwork.
...
- Ordinary text readability and broad similarity, raster title-art identity, shape construction, and button construction.
