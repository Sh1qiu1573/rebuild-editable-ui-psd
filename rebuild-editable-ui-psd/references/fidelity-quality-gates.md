# V3.6 representation and human quality gates

## 1. Acceptance authority

V3.5 uses two blocking human-review gates:
...
- Fully visible objects may be extracted from source with bundled rembg and approved masks.
