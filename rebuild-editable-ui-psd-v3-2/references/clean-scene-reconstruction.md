...
V3.2 uses `full-scene-regeneration` by default. Generate one complete UI-free scene and use it as the entire scene smart object.
...
- **The user now requires original scene preservation:** stop and switch to a source-preserving workflow; do not introduce masked splicing into v3.2.
