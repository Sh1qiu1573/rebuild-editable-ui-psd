...
Human review is blocking in v3.2. Record both review rounds in `human-review.json`. Do not infer approval from silence, a previous task, or an AI assessment.
